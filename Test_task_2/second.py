...
"""
Да, решение так себе (про использование yield from), но я вообще не понимаю, как использовать yield не переписывая всю
функцию, при этом оставив её рекурсивной.
Короче, либо я тупой, либо лыжи не едут
"""
